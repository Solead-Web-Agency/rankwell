      ...
      <section className="py-20 px-4 bg-gradient-to-br from-blue-50 to-indigo-100">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Parlons de votre projet et découvrez comment nous pouvons vous aider à atteindre vos objectifs
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Notre équipe est à votre écoute pour comprendre vos besoins et vous proposer 
                des solutions adaptées. N'hésitez pas à nous contacter pour un premier échange gratuit.
              </p>
        ...
        <div className="container mx-auto">
          <div className="bg-gray-300 rounded-2xl h-96 flex items-center justify-center">
            <p className="text-gray-600">
              📍 Carte Google Maps - Intégrez votre carte ici
            </p>
          </div>
        </div>
      </section>
