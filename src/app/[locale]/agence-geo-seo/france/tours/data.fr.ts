/**
 * DATA - Page Tours (Agence GEO & SEO pour les entreprises tourangelles)
 * URL: /agence-geo-seo/france/tours (FR only)
 *
 * Page locale SANS présence physique
 * Mots-clés: Agence SEO Tours, Agence GEO Tours, Référencement Tours
 */
...
export const metadata = {
  title: 'Agence GEO et SEO pour les entreprises tourangelles - Rankwell',
  description:
    'Expertise SEO et GEO pour les entreprises de Tours. Référencement Google et optimisation pour les moteurs IA. Bureaux à Paris, collaboration à distance efficace. Approche business centrix.',
};
...
export const heroData = {
  ...
  badge: 'tours',
  title: 'Agence GEO et SEO à Tours',
  description:
    'Tours est le cœur économique de la Touraine et une métropole dynamique au centre des Châteaux de la Loire. Les entreprises tourangelles évoluent sur un territoire attractif où la visibilité digitale fait la différence. SEO, GEO, SEA et Data.',
  primaryCta: {
...
export const introData = {
  ...
  title: 'Une expertise Search nationale accessible aux entreprises tourangelles',
  paragraphs: [
    'Tours et sa métropole constituent un bassin économique diversifié. Cosmétique, pharmacie, tourisme patrimonial, services aux entreprises : chaque secteur compte des acteurs qui cherchent à se démarquer. Google ne représente plus l\'unique vitrine. ChatGPT, Perplexity et les AI Overviews redéfinissent les parcours de recherche des décideurs.',
    'Rankwell accompagne des entreprises dans toute la France depuis 2017. Notre expertise GEO et SEO est accessible aux entreprises tourangelles grâce à une <strong>collaboration à distance efficace</strong>. Échanges réguliers en visioconférence, outils collaboratifs, suivi en temps réel via notre plateforme Rankwell One.',
...
export const recapData = {
  sectionId: 'recap',
  badge: 'Rankwell pour Tours',
  title: 'Ce que nous apportons aux entreprises tourangelles',
...
export const geoEducationData = {
  ...
  items: [
    ...
    },
    {
      ...
      desc: 'Les IA vérifient votre crédibilité via les mentions externes : presse spécialisée, guides touristiques, avis d\'experts. Le netlinking reste essentiel, mais sous une forme renouvelée.',
    },
  ],
};
...
export const calloutData = {
  label: 'Le contexte économique tourangeau',
  text: 'Tours Métropole rassemble plus de 300 000 habitants et bénéficie d\'une position stratégique à 1h de Paris en TGV. La Cosmetic Valley, l\'industrie pharmaceutique, le tourisme des Châteaux de la Loire et un tissu de PME dynamiques forment une économie diversifiée. Une visibilité digitale optimisée permet de capter des opportunités bien au-delà de la région.',
...
export const expertisesData = {
  ...
  badge: 'Nos services',
  accentColor: 'rw-blue' as const,
  title: 'Nos services GEO & SEO à Tours',
  subtitle: 'Quatre services complémentaires pour développer votre acquisition digitale et transformer vos visiteurs en clients.',
  items: [
    {
      id: 1,
      title: 'Audit SEO complet',
      description: 'État des lieux exhaustif de votre site : analyse technique, sémantique et étude de la concurrence pour prioriser les actions.',
    ...
    },
    {
      ...
      description: 'Travail sur la structure du site, l\'optimisation des contenus et les performances pour satisfaire les critères des moteurs.',
    ...
    },
    {
      id: 3,
      title: 'Netlinking',
      description: 'Construction d\'un profil de liens solide avec des backlinks issus de sites fiables. Qualité avant quantité, toujours.',
    ...
    },
    {
      ...
      description: 'Production de contenus SEO et GEO-ready, structurés pour répondre aux requêtes et déclencher des actions concrètes.',
...
export const comparaisonData = {
  ...
  badge: 'SEO + GEO',
  accentColor: 'rw-blue' as const,
  title: 'Ce que les entreprises tourangelles gagnent avec le GEO',
...
export const quoteData = {
  quote: 'Link building really boils down to quality over quantity, and getting cited by the right publication is a step in the right direction towards building authority.',
  author: 'Amanda Milligan',
  role: 'Founder Brand Authority Club',
};
...
export const faqData = {
  ...
  items: [
    {
      id: '1',
      question: 'Travaillez-vous avec des entreprises à Tours ?',
      answer: 'Oui, nous collaborons avec des entreprises tourangelles depuis plusieurs années. Visioconférences régulières, accès à Rankwell One pour suivre vos performances en temps réel, consultant senior dédié joignable par email ou téléphone. La collaboration à distance est parfaitement fluide.',
    },
    {
      id: '2',
      question: 'Quels secteurs accompagnez-vous à Tours ?',
      answer: 'Nous intervenons dans tous les secteurs : cosmétique et parfumerie (proximité de la Cosmetic Valley), pharmacie, tourisme patrimonial, services B2B, e-commerce. Le dénominateur commun : des entreprises qui veulent convertir leur visibilité Search en résultats commerciaux.',
    },
    {
      id: '3',
