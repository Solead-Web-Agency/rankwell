/**
 * DATA - Page Blois (Agence GEO & SEO pour les entreprises blésoises)
 * URL: /agence-geo-seo/france/blois (FR only)
 *
 * Page locale SANS présence physique
 * Mots-clés: Agence SEO Blois, Agence GEO Blois, Référencement Blois
 */
...
export const heroData = {
  ...
  badge: 'blois',
  title: 'Agence GEO et SEO à Blois',
  description:
    'Blois est la préfecture du Loir-et-Cher et le cœur touristique des Châteaux de la Loire. Les entreprises blésoises portent un patrimoine exceptionnel qui mérite une visibilité digitale optimisée. SEO, GEO, SEA et Data.',
  primaryCta: {
...
export const introData = {
  ...
  title: 'Une expertise Search nationale accessible aux entreprises blésoises',
  paragraphs: [
    'Blois et son agglomération constituent un bassin économique ancré dans le tourisme patrimonial. Châteaux de la Loire, gastronomie, hôtellerie, commerce : chaque secteur compte des acteurs qui cherchent à capter une clientèle nationale et internationale. Google ne représente plus l\'unique canal de visibilité. ChatGPT, Perplexity et les AI Overviews transforment les parcours de recherche des voyageurs.',
    'Rankwell accompagne des entreprises dans toute la France depuis 2017. Notre expertise GEO et SEO est accessible aux entreprises blésoises grâce à une <strong>collaboration à distance efficace</strong>. Échanges réguliers en visioconférence, outils collaboratifs partagés, suivi en temps réel via notre plateforme Rankwell One.',
...
export const recapData = {
  sectionId: 'recap',
  badge: 'Rankwell pour Blois',
  title: 'Ce que nous apportons aux entreprises blésoises',
...
export const geoEducationData = {
  ...
  items: [
    ...
    },
    {
      ...
      desc: 'Les IA valident votre crédibilité grâce aux mentions externes : guides touristiques, presse spécialisée, avis d\'experts. Le netlinking reste essentiel, mais sous une forme renouvelée.',
    },
  ],
};
...
export const calloutData = {
  label: 'Le contexte économique blésois',
  text: 'Blois compte près de 50 000 habitants et accueille des centaines de milliers de visiteurs chaque année, attirés par le château royal et la proximité de Chambord et Cheverny. Le tourisme patrimonial, l\'hôtellerie-restauration, le commerce et l\'artisanat forment un tissu économique tourné vers l\'accueil. Une visibilité digitale optimisée permet de capter ces flux de visiteurs en amont de leur voyage.',
  ...
  items: [
    {
      ...
      description:
        'Être premier sur un mot-clé sans potentiel commercial n\'a pas de sens. Notre indicateur principal, c\'est l\'impact sur votre activité : réservations, visites, chiffre d\'affaires attribué.',
    },
    {
      id: 2,
      icon: 'MessageCircle',
  ...
  criteria: [
    {
      ...
      description: 'Votre site existe mais ne génère pas suffisamment de réservations ou de visites. Vous recherchez un partenaire pour élaborer et déployer une stratégie Search performante.',
    },
    {
...
export const expertisesData = {
  ...
  badge: 'Nos services',
  accentColor: 'rw-blue' as const,
  title: 'Nos services GEO & SEO à Blois',
  subtitle: 'Quatre services complémentaires pour développer votre visibilité sur Google et les moteurs IA.',
  items: [
    {
      id: 1,
      title: 'Audit SEO complet',
      description: 'Analyse technique, sémantique et concurrentielle de votre site. Nous identifions les opportunités et les freins à votre visibilité.',
    ...
    },
    {
      ...
      description: 'Optimisation on-site complète : structure de contenu, balises, maillage interne et performance technique pour satisfaire Google et les IA.',
    ...
    },
    {
      id: 3,
      title: 'Netlinking',
      description: 'Acquisition de liens de qualité auprès de sites pertinents. Stratégie white-hat, sans spam, pour renforcer durablement votre autorité.',
    ...
    },
    {
      ...
      description: 'Contenus optimisés SEO et GEO-ready qui répondent aux intentions de recherche et génèrent des conversions.',
...
export const comparaisonData = {
  ...
  badge: 'SEO + GEO',
  accentColor: 'rw-blue' as const,
  title: 'Ce que les entreprises blésoises gagnent avec le GEO',
...
export const faqData = {
  ...
  items: [
    {
      id: '1',
      question: 'Travaillez-vous avec des entreprises à Blois ?',
      answer: 'Oui, nous collaborons avec des entreprises blésoises depuis plusieurs années. Visioconférences régulières, accès à Rankwell One pour suivre vos performances en temps réel, consultant senior dédié joignable par email ou téléphone. La collaboration à distance est parfaitement fluide.',
    },
    {
      id: '2',
      question: 'Quels secteurs accompagnez-vous à Blois ?',
      answer: 'Nous intervenons dans tous les secteurs : tourisme patrimonial (le cœur de l\'économie blésoise), hôtellerie-restauration, commerce, artisanat, services B2B, e-commerce. Le dénominateur commun : des entreprises qui veulent convertir leur visibilité Search en résultats commerciaux.',
    },
    {
      id: '3',
