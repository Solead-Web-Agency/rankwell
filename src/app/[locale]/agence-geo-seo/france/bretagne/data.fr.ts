...
export const quoteData = {
  quote: 'If you don\'t get the foundational technical SEO right, you don\'t have a platform to build upon.',
  author: 'Patrick Stox',
  role: 'Product Advisor, Technical SEO & Brand Ambassador, Ahrefs',
};
