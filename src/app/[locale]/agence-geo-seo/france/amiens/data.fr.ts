/**
 * DATA - Page Amiens (Agence GEO & SEO pour les entreprises amiénoises)
 * URL: /agence-geo-seo/france/amiens (FR only)
 *
 * Page locale SANS présence physique
 * Mots-clés: Agence SEO Amiens, Agence GEO Amiens, Référencement Amiens
 */
...
export const metadata = {
  title: 'Agence GEO et SEO pour les entreprises amiénoises - Rankwell',
  description:
    'Expertise SEO et GEO pour les entreprises d\'Amiens et la Picardie. Référencement Google et optimisation pour les moteurs IA. Bureaux à Paris, collaboration à distance efficace. Approche business centrix.',
};
...
export const heroData = {
  ...
  badge: 'amiens',
  title: 'Agence GEO et SEO à Amiens',
  description:
    'Amiens est la préfecture des Hauts-de-France et un pôle économique historique de la Picardie. Les entreprises amiénoises évoluent dans un territoire en transformation où la visibilité digitale fait la différence. SEO, GEO, SEA et Data.',
  primaryCta: {
...
export const introData = {
  ...
  title: 'Une expertise Search nationale accessible aux entreprises amiénoises',
  paragraphs: [
    'Amiens et son agglomération forment un bassin économique diversifié. Logistique, agroalimentaire, santé, services, industrie : chaque secteur compte des acteurs qui cherchent à se démarquer. Google ne représente plus l\'unique vitrine. ChatGPT, Perplexity et les AI Overviews redéfinissent les parcours de recherche des décideurs.',
    'Rankwell accompagne des entreprises dans toute la France depuis 2017. Notre expertise GEO et SEO est accessible aux entreprises amiénoises grâce à une <strong>collaboration à distance efficace</strong>. Échanges réguliers en visioconférence, outils collaboratifs, suivi en temps réel via notre plateforme Rankwell One.',
...
export const recapData = {
  sectionId: 'recap',
  badge: 'Rankwell pour Amiens',
  title: 'Ce que nous apportons aux entreprises amiénoises',
...
export const geoEducationData = {
  ...
  items: [
    ...
    },
    {
      ...
      desc: 'Les IA vérifient votre crédibilité via les mentions externes : presse spécialisée, médias locaux et nationaux, avis d\'experts. Le netlinking reste essentiel, mais sous une forme renouvelée.',
    },
  ],
};
...
export const calloutData = {
  label: 'Le contexte économique amiénois',
  text: 'Amiens Métropole regroupe plus de 180 000 habitants et bénéficie d\'une position stratégique à 1h20 de Paris, 1h30 de Lille. Classée au patrimoine mondial de l\'UNESCO pour sa cathédrale, la ville développe des pôles santé, logistique et numérique. Une visibilité digitale optimisée permet de capter des opportunités au-delà de la région.',
...
export const expertisesData = {
  ...
  badge: 'Nos services',
  accentColor: 'rw-blue' as const,
  title: 'Nos services GEO & SEO à Amiens',
  subtitle: 'Quatre services complémentaires pour maximiser votre visibilité digitale.',
  items: [
    {
      id: 1,
      title: 'Audit SEO complet',
      description: 'Analyse technique, sémantique et concurrentielle. Identification des freins et des opportunités de croissance.',
    ...
    },
    {
      ...
      description: 'Optimisation on-site, architecture de contenu, balisage et performance. Les fondations d\'un SEO durable.',
    ...
    },
    {
      id: 3,
      title: 'Netlinking',
      description: 'Stratégie de liens qualitatifs pour consolider votre autorité. Pas de spam ni de pratiques risquées.',
    ...
    },
    {
      ...
      description: 'Contenus optimisés SEO et GEO-ready. Du contenu qui se positionne et qui convertit.',
...
export const comparaisonData = {
  ...
  badge: 'SEO + GEO',
  accentColor: 'rw-blue' as const,
  title: 'Ce que les entreprises amiénoises gagnent avec le GEO',
...
export const quoteData = {
  quote: 'Marketing is telling the world you\'re a rock star. Content marketing is showing the world you are one.',
  author: 'Robert Rose',
  role: 'Founder, The Content Advisory',
};
...
export const faqData = {
  ...
  items: [
    {
      id: '1',
      question: 'Travaillez-vous avec des entreprises à Amiens ?',
      answer: 'Oui, nous collaborons avec des entreprises amiénoises depuis plusieurs années. Visioconférences régulières, accès à Rankwell One pour suivre vos performances en temps réel, consultant senior dédié joignable par email ou téléphone. La collaboration à distance est parfaitement fluide.',
    },
    {
      id: '2',
      question: 'Quels secteurs accompagnez-vous à Amiens ?',
      answer: 'Nous intervenons dans tous les secteurs : logistique, agroalimentaire, santé et bien-être, services B2B, tourisme culturel, e-commerce. Le dénominateur commun : des entreprises qui veulent convertir leur visibilité Search en résultats commerciaux.',
    },
    {
      id: '3',
