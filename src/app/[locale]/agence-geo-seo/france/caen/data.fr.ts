/**
 * DATA - Page Caen (Agence GEO & SEO pour les entreprises caennaises)
 * URL: /agence-geo-seo/france/caen (FR only)
 *
 * Page locale SANS présence physique
 * Mots-clés: Agence SEO Caen, Agence GEO Caen, Référencement Caen
 */
...
export const metadata = {
  title: 'Agence GEO et SEO pour les entreprises caennaises - Rankwell',
  description:
    'Expertise SEO et GEO pour les entreprises de Caen. Référencement Google et optimisation pour les moteurs IA. Bureaux à Paris, collaboration à distance efficace. Approche business centrix.',
};
...
export const heroData = {
  ...
  badge: 'caen',
  title: 'Agence GEO et SEO à Caen',
  description:
    'Caen est le cœur économique de la Normandie occidentale et une métropole universitaire dynamique. Les entreprises caennaises évoluent dans un territoire attractif où la visibilité digitale fait la différence. SEO, GEO, SEA et Data.',
  primaryCta: {
...
export const introData = {
  ...
  title: 'Une expertise Search nationale accessible aux entreprises caennaises',
  paragraphs: [
    'Caen et son agglomération constituent un bassin économique diversifié. Automobile, agroalimentaire, santé, technologies numériques, tourisme mémoriel : chaque secteur compte des acteurs qui cherchent à se démarquer. Google ne représente plus l\'unique vitrine. ChatGPT, Perplexity et les AI Overviews redéfinissent les parcours de recherche des décideurs.',
    'Rankwell accompagne des entreprises dans toute la France depuis 2017. Notre expertise GEO et SEO est accessible aux entreprises caennaises grâce à une <strong>collaboration à distance efficace</strong>. Échanges réguliers en visioconférence, outils collaboratifs, suivi en temps réel via notre plateforme Rankwell One.',
...
export const recapData = {
  sectionId: 'recap',
  badge: 'Rankwell pour Caen',
  title: 'Ce que nous apportons aux entreprises caennaises',
...
export const geoEducationData = {
  ...
  items: [
    ...
    },
    {
      ...
      desc: 'Les IA vérifient votre crédibilité via les mentions externes : presse spécialisée, médias professionnels, avis d\'experts. Le netlinking reste essentiel, mais sous une forme renouvelée.',
    },
  ],
};
...
export const calloutData = {
  label: 'Le contexte économique caennais',
  text: 'Caen la Mer compte plus de 270 000 habitants et abrite une université de 30 000 étudiants. La métropole s\'appuie sur des pôles d\'excellence : automobile avec PSA et Renault Trucks, agroalimentaire normand, santé et biotechnologies, tourisme mémoriel lié au Débarquement. Une visibilité digitale optimisée permet de capter des opportunités bien au-delà de la région.',
...
export const expertisesData = {
  ...
  badge: 'Nos services',
  accentColor: 'rw-blue' as const,
  title: 'Nos services GEO & SEO à Caen',
  subtitle: 'Quatre services complémentaires pour accroître votre visibilité sur Google et les moteurs IA.',
  items: [
    {
      id: 1,
      title: 'Audit SEO complet',
      description: 'Analyse approfondie de votre site : aspects techniques, contenus et environnement concurrentiel. Un état des lieux précis pour agir efficacement.',
    ...
    },
    {
      ...
      description: 'Optimisation on-site complète : hiérarchie de contenu, balises stratégiques, maillage interne et temps de chargement optimisé.',
    ...
    },
    {
      id: 3,
      title: 'Netlinking',
      description: 'Stratégie d\'acquisition de liens naturels et durables. Partenariats de qualité, sans pratiques risquées, pour asseoir votre crédibilité.',
    ...
    },
    {
      ...
      description: 'Contenus optimisés pour le référencement et adaptés aux moteurs IA, pensés pour attirer et convertir votre audience cible.',
...
export const comparaisonData = {
  ...
  badge: 'SEO + GEO',
  accentColor: 'rw-blue' as const,
  title: 'Ce que les entreprises caennaises gagnent avec le GEO',
...
export const quoteData = {
  quote: 'SEO has been way too navel-gazing about its own capabilities for so long that we\'ve forgotten that we exist in a bigger matrix of marketing.',
  author: 'Mordy Oberstein',
  role: 'Head of SEO Brand, Wix',
};
...
export const faqData = {
  ...
  items: [
    {
      id: '1',
      question: 'Travaillez-vous avec des entreprises à Caen ?',
      answer: 'Oui, nous collaborons avec des entreprises caennaises depuis plusieurs années. Visioconférences régulières, accès à Rankwell One pour suivre vos performances en temps réel, consultant senior dédié joignable par email ou téléphone. La collaboration à distance est parfaitement fluide.',
    },
    {
      id: '2',
      question: 'Quels secteurs accompagnez-vous à Caen ?',
      answer: 'Nous intervenons dans tous les secteurs : automobile, agroalimentaire, santé et biotechnologies, tourisme mémoriel, services B2B, e-commerce. Le dénominateur commun : des entreprises qui veulent convertir leur visibilité Search en résultats commerciaux.',
    },
    {
      id: '3',
