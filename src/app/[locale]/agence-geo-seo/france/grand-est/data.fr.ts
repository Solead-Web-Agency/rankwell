/**
 * DATA - Page Grand Est (Agence GEO & SEO pour les entreprises du Grand Est)
 * URL: /agence-geo-seo/france/grand-est (FR only)
 *
 * Page régionale SANS présence physique
 * Mots-clés: Agence SEO Grand Est, Agence GEO Grand Est, Référencement Alsace Lorraine
 */
...
export const metadata = {
  title: 'Agence GEO et SEO pour les entreprises du Grand Est - Rankwell',
  description:
    'Expertise SEO et GEO pour les entreprises du Grand Est. Référencement Google et optimisation pour les moteurs IA. Bureaux à Paris, collaboration à distance efficace. Approche business centrix.',
};
...
export const heroData = {
  ...
  badge: 'grand-est',
  title: 'Agence GEO et SEO en Grand Est',
  description:
    'Le Grand Est réunit l\'Alsace, la Lorraine et la Champagne-Ardenne. Strasbourg, Reims, Metz, Nancy, Colmar... autant de pôles économiques où les entreprises peuvent développer leur visibilité digitale. SEO, GEO, SEA et Data.',
  primaryCta: {
...
export const introData = {
  ...
  title: 'Une expertise Search nationale au service des entreprises du Grand Est',
  paragraphs: [
    'Le Grand Est forme une région économique stratégique aux frontières de l\'Allemagne, la Belgique, le Luxembourg et la Suisse. Automobile, viticulture, luxe, industrie, institutions européennes : les secteurs qui font la richesse régionale nécessitent une présence digitale performante. Google ne constitue plus l\'unique vitrine. ChatGPT, Perplexity et les AI Overviews modifient les comportements de recherche des décideurs.',
    'Rankwell accompagne des entreprises sur l\'ensemble du territoire national depuis 2017. Notre maîtrise du GEO et du SEO profite aux entreprises du Grand Est via une <strong>collaboration à distance efficace</strong>. Points réguliers en visioconférence, outils collaboratifs, reporting en temps réel via notre plateforme Rankwell One.',
...
export const recapData = {
  sectionId: 'recap',
  badge: 'Rankwell pour le Grand Est',
  title: 'Ce que nous apportons aux entreprises du Grand Est',
...
export const calloutData = {
  label: 'L\'économie du Grand Est',
  text: 'Le Grand Est compte 5,5 millions d\'habitants et constitue la cinquième région économique française. Première région viticole (Champagne, Alsace), siège du Parlement européen à Strasbourg, pôles automobile et ferroviaire majeurs. Une visibilité digitale optimisée permet de rayonner sur les marchés français et transfrontaliers.',
...
export const expertisesData = {
  ...
  badge: 'Nos services',
  accentColor: 'rw-blue' as const,
  title: 'Nos services GEO & SEO en Grand Est',
  subtitle: 'Quatre services complémentaires pour développer votre visibilité sur Google et les moteurs IA.',
  items: [
    {
      id: 1,
      title: 'Audit SEO complet',
      description: 'Analyse technique, sémantique et concurrentielle de votre site. Un diagnostic approfondi pour identifier les leviers de croissance et les points de blocage.',
    ...
    },
    {
      ...
      description: 'Optimisation on-site complète : structure de contenu, maillage interne, performance technique et Core Web Vitals pour des fondations solides.',
    ...
    },
    {
      id: 3,
      title: 'Netlinking',
      description: 'Acquisition de liens de qualité via des partenariats éditoriaux ciblés. Aucune technique spammy, uniquement des backlinks pertinents et durables.',
    ...
    },
    {
      ...
      description: 'Contenus optimisés SEO et GEO-ready qui répondent aux intentions de recherche et convertissent vos visiteurs en clients.',
...
export const comparaisonData = {
  ...
  badge: 'SEO + GEO',
  accentColor: 'rw-blue' as const,
  title: 'Ce que les entreprises du Grand Est gagnent avec le GEO',
...
export const quoteData = {
  quote: 'The key to thriving in SEO lies in effort, experience, and experimentation. Understanding your audience and delivering precisely what they need sets you apart.',
  author: 'Sam Oh',
  role: 'VP of Marketing, Ahrefs',
};
...
export const faqData = {
  ...
  items: [
    {
      id: '1',
      question: 'Travaillez-vous avec des entreprises du Grand Est ?',
      answer: 'Oui, nous collaborons avec des entreprises du Grand Est depuis plusieurs années. Visioconférences régulières, accès à Rankwell One pour suivre vos performances en temps réel, consultant senior dédié joignable par email ou téléphone. La collaboration à distance fonctionne parfaitement.',
    },
    {
      id: '2',
      question: 'Quels secteurs accompagnez-vous dans le Grand Est ?',
      answer: 'Nous intervenons dans tous les secteurs : viticulture et champagne, automobile et ferroviaire, institutions européennes, industrie, tourisme et œnotourisme, e-commerce. Le dénominateur commun : des entreprises qui veulent transformer leur visibilité Search en résultats commerciaux.',
    },
    {
      id: '3',
...
export const autresVillesData = {
  title: 'Découvrez aussi nos services dans ces villes du Grand Est',
  cities: [
