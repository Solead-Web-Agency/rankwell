...
export const quoteData = {
  quote: 'We want to provide data that is actionable, not just interesting. The goal is to help site owners make informed decisions about their search presence.',
