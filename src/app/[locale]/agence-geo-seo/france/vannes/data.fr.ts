/**
 * DATA - Page Vannes (Agence GEO & SEO pour les entreprises vannetaises)
 * URL: /agence-geo-seo/france/vannes (FR only)
 *
 * Page locale SANS présence physique
 * Mots-clés: Agence SEO Vannes, Agence GEO Vannes, Référencement Vannes
 */
...
export const heroData = {
  ...
  badge: 'vannes',
  title: 'Agence GEO et SEO à Vannes',
  description:
    'Vannes est la porte d\'entrée du Golfe du Morbihan et un pôle économique attractif de Bretagne sud. Les entreprises vannetaises méritent une visibilité digitale à la hauteur de leur dynamisme. SEO, GEO, SEA et Data.',
  primaryCta: {
...
export const introData = {
  ...
  title: 'Une expertise Search nationale accessible aux entreprises vannetaises',
  paragraphs: [
    'Vannes et le Golfe du Morbihan constituent un bassin économique en pleine expansion. Tourisme, nautisme, agroalimentaire, services : chaque secteur rassemble des acteurs ambitieux qui cherchent à se démarquer. Google ne représente plus l\'unique canal de visibilité. ChatGPT, Perplexity et les AI Overviews transforment les habitudes de recherche.',
    'Rankwell accompagne des entreprises dans toute la France depuis 2017. Notre expertise GEO et SEO est accessible aux entreprises vannetaises grâce à une <strong>collaboration à distance fluide</strong>. Points réguliers en visioconférence, outils collaboratifs partagés, suivi permanent via notre plateforme Rankwell One.',
...
export const recapData = {
  sectionId: 'recap',
  badge: 'Rankwell pour Vannes',
  title: 'Ce que nous apportons aux entreprises vannetaises',
  ...
  items: [
    {
      ...
      desc: 'GEO (Generative Engine Optimization) désigne l\'art d\'optimiser vos contenus pour être mentionné par les moteurs IA comme ChatGPT, Perplexity ou les AI Overviews de Google. L\'enjeu dépasse le classement : devenir la source que l\'IA choisit de citer.',
    },
    {
      id: 2,
...
export const calloutData = {
  label: 'Le contexte économique vannetais',
  text: 'Vannes compte plus de 55 000 habitants et attire chaque année des milliers de visiteurs venus découvrir le Golfe du Morbihan. Le nautisme, le tourisme, l\'agroalimentaire et un tissu dynamique de PME forment une économie diversifiée. Une visibilité digitale optimisée permet de capter ces flux de visiteurs et de prospects nationaux.',
...
export const expertisesData = {
  ...
  badge: 'Nos services',
  accentColor: 'rw-blue' as const,
  title: 'Nos services GEO & SEO à Vannes',
  subtitle: 'Quatre services complémentaires pour accroître votre visibilité en ligne et convertir vos prospects.',
  items: [
    {
      id: 1,
      title: 'Audit SEO complet',
      description: 'Diagnostic complet de votre site web : aspects techniques, qualité sémantique et analyse de votre environnement concurrentiel.',
    ...
    },
    {
      ...
      description: 'Amélioration de la structure, enrichissement des contenus et optimisation des performances pour un meilleur référencement.',
    ...
    },
    {
      id: 3,
      title: 'Netlinking',
      description: 'Développement d\'un réseau de liens qualitatifs issus de sites de confiance. Approche propre, résultats durables.',
    ...
    },
    {
      ...
      description: 'Rédaction de contenus SEO et GEO-ready qui répondent aux attentes des utilisateurs et favorisent les conversions.',
...
export const comparaisonData = {
  ...
  badge: 'SEO + GEO',
  accentColor: 'rw-blue' as const,
  title: 'Ce que les entreprises vannetaises gagnent avec le GEO',
...
export const faqData = {
  ...
  items: [
    {
      id: '1',
      question: 'Travaillez-vous avec des entreprises à Vannes ?',
      answer: 'Oui, nous collaborons avec des entreprises vannetaises depuis plusieurs années. Visioconférences régulières, accès à Rankwell One pour suivre vos performances en temps réel, consultant senior dédié joignable par email ou téléphone. La collaboration à distance est parfaitement fluide.',
    },
    {
      id: '2',
      question: 'Quels secteurs accompagnez-vous à Vannes ?',
      answer: 'Nous intervenons dans tous les secteurs : tourisme et hôtellerie, nautisme (un pilier de l\'économie vannetaise), commerce, services B2B, e-commerce. Le dénominateur commun : des entreprises qui veulent convertir leur visibilité Search en résultats commerciaux.',
    },
    {
      id: '3',
