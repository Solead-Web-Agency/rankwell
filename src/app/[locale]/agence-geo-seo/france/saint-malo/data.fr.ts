/**
 * DATA - Page Saint-Malo (Agence GEO & SEO pour les entreprises malouines)
 * URL: /agence-geo-seo/france/saint-malo (FR only)
 *
 * Page locale SANS présence physique
 * Mots-clés: Agence SEO Saint-Malo, Agence GEO Saint-Malo, Référencement Saint-Malo
 */
...
export const metadata = {
  title: 'Agence GEO et SEO pour les entreprises malouines - Rankwell',
  description:
    'Expertise SEO et GEO pour les entreprises de Saint-Malo. Référencement Google et optimisation pour les moteurs IA. Bureaux à Paris, collaboration à distance efficace. Approche business centrix.',
};
...
export const heroData = {
  ...
  badge: 'saint-malo',
  title: 'Agence GEO et SEO à Saint-Malo',
  description:
    'Saint-Malo est une cité corsaire au rayonnement international, conjuguant patrimoine et dynamisme économique. Les entreprises malouines portent un esprit d\'aventure qui mérite une visibilité digitale optimisée. SEO, GEO, SEA et Data.',
  primaryCta: {
...
export const introData = {
  ...
  title: 'Une expertise Search nationale accessible aux entreprises malouines',
  paragraphs: [
    'Saint-Malo possède une économie singulière marquée par le maritime, le tourisme et l\'entrepreneuriat. Armateurs, hôteliers, startups, commerces : chaque acteur cherche à rayonner au-delà des remparts. Google ne constitue plus l\'unique canal de visibilité. ChatGPT, Perplexity et les AI Overviews transforment les parcours de recherche des visiteurs et des décideurs B2B.',
    'Rankwell accompagne des entreprises partout en France depuis 2017. Notre expertise GEO et SEO est accessible aux entreprises malouines via une <strong>collaboration à distance fluide</strong>. Échanges réguliers en visioconférence, outils collaboratifs partagés, suivi en temps réel grâce à notre plateforme Rankwell One.',
    'Découvrez notre accompagnement pour les entreprises ambitieuses qui veulent conquérir Google et les moteurs IA, avec une approche <strong>business centrix</strong> qui évalue la réussite sur les conversions, pas sur les positions.',
  ],
  tocItems: [
...
export const recapData = {
  sectionId: 'recap',
  badge: 'Rankwell pour Saint-Malo',
  title: 'Ce que nous apportons aux entreprises malouines',
  ...
  items: [
    ...
    },
    {
      ...
      description: 'Visios régulières, outils partagés, disponibilité.',
    },
    {
      id: 4,
      icon: 'UserCheck',
...
export const geoEducationData = {
  ...
  subtitle:
    'Le SEO classique cible les résultats traditionnels de Google. C\'est toujours fondamental. Mais une transformation majeure s\'opère : les utilisateurs interrogent de plus en plus directement des intelligences artificielles.',
  items: [
    {
      id: 1,
      title: 'Qu\'est-ce que le GEO ?',
      desc: 'GEO (Generative Engine Optimization) représente l\'art d\'optimiser vos contenus pour être mentionné par les moteurs IA comme ChatGPT, Perplexity ou les AI Overviews de Google. L\'enjeu n\'est plus seulement de ranker, mais de devenir la source que l\'IA choisit de citer.',
    },
    {
      id: 2,
      title: 'Contenus citation-ready',
      desc: 'Les IA recherchent des passages faciles à extraire et reformuler. Définitions précises, listes structurées, données chiffrées sourcées. Nous concevons vos contenus pour favoriser au maximum les citations.',
    },
    {
      id: 3,
      title: 'Autorité thématique',
      desc: 'Les LLMs évaluent si vous constituez une source légitime sur un sujet. Pas seulement si vous avez publié un contenu, mais si votre empreinte digitale globale démontre une expertise cohérente.',
    },
    {
      id: 4,
      title: 'Réseau de mentions',
      desc: 'Les IA valident votre crédibilité grâce aux mentions externes : couverture presse, guides touristiques, avis d\'experts. Le netlinking reste essentiel, mais sous une forme renouvelée.',
    },
  ],
};
...
export const calloutData = {
  label: 'Le contexte économique malouin',
  text: 'Saint-Malo compte près de 50 000 habitants et accueille plus de 2 millions de visiteurs par an. Le tourisme, l\'économie maritime (Brittany Ferries, transport de fret), l\'industrie agroalimentaire et un écosystème de startups dynamique forment un tissu économique tourné vers l\'international. Une visibilité digitale optimisée permet de capter ces flux de visiteurs et de prospects.',
  ...
  criteria: [
    {
      ...
      description: 'Votre site existe mais ne génère pas suffisamment de réservations ou de leads. Vous recherchez un partenaire pour élaborer et déployer une stratégie Search performante.',
    },
    {
...
export const expertisesData = {
  ...
  badge: 'Nos services',
  accentColor: 'rw-blue' as const,
  title: 'Nos services GEO & SEO à Saint-Malo',
  subtitle: 'Quatre services complémentaires pour maximiser votre présence en ligne et attirer des clients qualifiés.',
  items: [
    {
      id: 1,
      title: 'Audit SEO complet',
      description: 'Diagnostic approfondi de votre site : technique, sémantique et benchmark concurrentiel pour définir les axes d\'amélioration.',
    ...
    },
    {
      ...
      description: 'Optimisation de la structure, des contenus et des performances techniques pour un référencement solide et durable.',
    ...
    },
    {
      id: 3,
      title: 'Netlinking',
      description: 'Stratégie d\'acquisition de liens qualitatifs depuis des sites de confiance. Aucune pratique douteuse, que du pertinent.',
    ...
    },
    {
      ...
      description: 'Rédaction de contenus pensés pour le SEO et le GEO, conçus pour informer, convaincre et convertir vos visiteurs.',
...
export const comparaisonData = {
  ...
  badge: 'SEO + GEO',
  accentColor: 'rw-blue' as const,
  title: 'Ce que les entreprises malouines gagnent avec le GEO',
...
export const quoteData = {
  quote: 'A content strategy is the high-level vision that guides future content development to deliver against a specific business objective.',
  author: 'Hannah Smith',
  role: 'Director Worderist',
};
...
export const faqData = {
  ...
  items: [
    {
      id: '1',
      question: 'Travaillez-vous avec des entreprises à Saint-Malo ?',
      answer: 'Oui, nous collaborons avec des entreprises malouines depuis plusieurs années. Visioconférences régulières, accès à Rankwell One pour suivre vos performances en temps réel, consultant senior dédié joignable par email ou téléphone. La collaboration à distance est parfaitement fluide.',
    },
    {
      id: '2',
      question: 'Quels secteurs accompagnez-vous à Saint-Malo ?',
      answer: 'Nous intervenons dans tous les secteurs : tourisme et hôtellerie (un pilier de l\'économie malouine), économie maritime, commerce, services B2B, e-commerce. Le dénominateur commun : des entreprises qui veulent convertir leur visibilité Search en résultats commerciaux.',
    },
    {
      id: '3',
