/**
 * DATA - Page Orléans (Agence GEO & SEO pour les entreprises orléanaises)
 * URL: /agence-geo-seo/france/orleans (FR only)
 *
 * Page locale SANS présence physique
 * Mots-clés: Agence SEO Orléans, Agence GEO Orléans, Référencement Orléans
 */
...
export const metadata = {
  title: 'Agence GEO et SEO pour les entreprises orléanaises - Rankwell',
  description:
    'Expertise SEO et GEO pour les entreprises d\'Orléans. Référencement Google et optimisation pour les moteurs IA. Bureaux à Paris, collaboration à distance efficace. Approche business centrix.',
};
...
export const heroData = {
  ...
  badge: 'orléans',
  title: 'Agence GEO et SEO à Orléans',
  description:
    'Orléans est la préfecture du Loiret et un carrefour logistique stratégique au cœur de la France. Les entreprises orléanaises évoluent sur un territoire en plein développement où la visibilité digitale constitue un atout décisif. SEO, GEO, SEA et Data.',
  primaryCta: {
...
export const introData = {
  ...
  title: 'Une expertise Search nationale accessible aux entreprises orléanaises',
  paragraphs: [
    'Orléans et sa métropole forment un pôle économique en pleine expansion. Logistique, cosmétique, pharmaceutique, services aux entreprises : chaque secteur rassemble des acteurs qui cherchent à rayonner au-delà de la région. Google ne représente plus l\'unique canal de visibilité. ChatGPT, Perplexity et les AI Overviews transforment les parcours de recherche des décideurs.',
    'Rankwell accompagne des entreprises dans toute la France depuis 2017. Notre expertise GEO et SEO est accessible aux entreprises orléanaises grâce à une <strong>collaboration à distance structurée</strong>. Points réguliers en visioconférence, outils collaboratifs partagés, suivi permanent via notre plateforme Rankwell One.',
...
export const recapData = {
  sectionId: 'recap',
  badge: 'Rankwell pour Orléans',
  title: 'Ce que nous apportons aux entreprises orléanaises',
  ...
  items: [
    ...
    },
    {
      ...
      description: 'Visios programmées, outils partagés, disponibilité.',
    },
    {
      id: 4,
      icon: 'UserCheck',
...
export const geoEducationData = {
  ...
  subtitle:
    'Le SEO traditionnel cible les résultats classiques de Google. C\'est toujours fondamental. Mais une transformation majeure s\'opère : les utilisateurs interrogent de plus en plus directement des intelligences artificielles.',
  items: [
    {
      id: 1,
    ...
    },
    {
      ...
      desc: 'Les IA valident votre crédibilité grâce aux mentions externes : presse spécialisée, études sectorielles, avis d\'experts. Le netlinking reste essentiel, mais sous une forme renouvelée.',
    },
  ],
};
...
export const calloutData = {
  label: 'Le contexte économique orléanais',
  text: 'Orléans Métropole compte près de 290 000 habitants et bénéficie d\'une position stratégique à 1h de Paris. Le pôle logistique (Amazon, autres grands entrepôts), la Cosmetic Valley à proximité, l\'industrie pharmaceutique et un tissu dynamique de PME forment une économie diversifiée. Une visibilité digitale optimisée permet de capter des opportunités nationales et internationales.',
  ...
  items: [
    {
      ...
      description:
        'Être premier sur un mot-clé sans potentiel commercial n\'a pas de sens. Notre indicateur principal, c\'est l\'impact sur votre activité : leads générés, ventes, chiffre d\'affaires attribué.',
    },
    {
      id: 2,
      icon: 'MessageCircle',
  ...
  criteria: [
    {
      ...
      description: 'Votre site existe mais ne génère pas suffisamment de leads ou de ventes. Vous recherchez un partenaire pour élaborer et déployer une stratégie Search performante.',
    },
    {
...
export const expertisesData = {
  ...
  badge: 'Nos services',
  accentColor: 'rw-blue' as const,
  title: 'Nos services GEO & SEO à Orléans',
  subtitle: 'Quatre services complémentaires pour amplifier votre présence sur Google et les moteurs IA.',
  items: [
    {
      id: 1,
      title: 'Audit SEO complet',
      description: 'Examen technique, sémantique et concurrentiel de votre site. Une analyse détaillée pour établir un plan d\'action hiérarchisé par impact.',
    ...
    },
    {
      ...
      description: 'Optimisation on-site approfondie : structuration éditoriale, maillage interne, performance technique et Core Web Vitals pour un site au top.',
    ...
    },
    {
      id: 3,
      title: 'Netlinking',
      description: 'Stratégie d\'acquisition de liens qualitatifs via des partenariats éditoriaux soigneusement sélectionnés. Aucun spam, des backlinks durables uniquement.',
    ...
    },
    {
      ...
      description: 'Conception de contenus SEO et GEO-ready qui attirent les bons visiteurs et les transforment en leads ou clients.',
...
export const comparaisonData = {
  ...
  badge: 'SEO + GEO',
  accentColor: 'rw-blue' as const,
  title: 'Ce que les entreprises orléanaises gagnent avec le GEO',
...
export const quoteData = {
  quote: 'This is probably the biggest paradigm shift in the information retrieval world ever. Let\'s not do things for search engines. Let\'s do things for humans.',
  author: 'Dawn Anderson',
  role: 'Managing Director, Move It Marketing',
};
...
export const faqData = {
  ...
  items: [
    {
      id: '1',
      question: 'Travaillez-vous avec des entreprises à Orléans ?',
      answer: 'Oui, nous collaborons avec des entreprises orléanaises depuis plusieurs années. Visioconférences régulières, accès à Rankwell One pour suivre vos performances en temps réel, consultant senior dédié joignable par email ou téléphone. La collaboration à distance est parfaitement fluide.',
    },
    {
      id: '2',
      question: 'Quels secteurs accompagnez-vous à Orléans ?',
      answer: 'Nous intervenons dans tous les secteurs : logistique (un pilier de l\'économie orléanaise), cosmétique, pharmaceutique, services B2B, e-commerce. Le dénominateur commun : des entreprises qui veulent convertir leur visibilité Search en résultats commerciaux.',
    },
    {
      id: '3',
