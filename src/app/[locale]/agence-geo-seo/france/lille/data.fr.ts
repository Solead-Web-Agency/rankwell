/**
 * DATA - Page Lille (Agence GEO & SEO pour les entreprises lilloises)
 * URL: /agence-geo-seo/france/lille (FR only)
 *
 * Page locale SANS présence physique
 * Mots-clés: Agence SEO Lille, Agence GEO Lille, Référencement Lille
 */
...
export const metadata = {
  title: 'Agence GEO et SEO pour les entreprises lilloises - Rankwell',
  description:
    'Expertise SEO et GEO pour les entreprises de Lille et la métropole européenne. Référencement Google et optimisation pour les moteurs IA. Bureaux à Paris, collaboration à distance efficace. Approche business centrix.',
};
...
export const heroData = {
  ...
  badge: 'lille',
  title: 'Agence GEO et SEO à Lille',
  description:
    'Lille est la capitale des Hauts-de-France et un carrefour économique européen. Les entreprises lilloises évoluent sur un territoire dynamique entre Paris, Bruxelles et Londres où la visibilité digitale fait la différence. SEO, GEO, SEA et Data.',
  primaryCta: {
...
export const introData = {
  ...
  title: 'Une expertise Search nationale accessible aux entreprises lilloises',
  paragraphs: [
    'Lille et la Métropole Européenne de Lille constituent un pôle économique de premier plan. Grande distribution, e-commerce, logistique, textile de luxe, industrie : chaque secteur compte des acteurs qui cherchent à se démarquer. Google ne constitue plus la seule vitrine. ChatGPT, Perplexity et les AI Overviews transforment les parcours de recherche des décideurs.',
    'Rankwell accompagne des entreprises partout en France depuis 2017. Notre expertise GEO et SEO est accessible aux entreprises lilloises grâce à une <strong>collaboration à distance efficace</strong>. Échanges réguliers en visioconférence, outils collaboratifs, suivi en temps réel via notre plateforme Rankwell One.',
...
export const recapData = {
  sectionId: 'recap',
  badge: 'Rankwell pour Lille',
  title: 'Ce que nous apportons aux entreprises lilloises',
...
export const calloutData = {
  label: 'Le contexte économique lillois',
  text: 'La Métropole Européenne de Lille rassemble 1,2 million d\'habitants et se positionne au cœur du triangle Paris-Londres-Bruxelles. Siège d\'Auchan, Décathlon, OVHcloud, Kiabi et de nombreuses startups tech, la métropole lilloise représente le quatrième bassin d\'emplois français. Une visibilité digitale optimisée permet de rayonner sur les marchés français et européens.',
...
export const expertisesData = {
  ...
  badge: 'Nos services',
  accentColor: 'rw-blue' as const,
  title: 'Nos services GEO & SEO à Lille',
  subtitle: 'Quatre services complémentaires pour développer votre visibilité digitale.',
  items: [
    {
      id: 1,
      title: 'Audit SEO complet',
      description: 'Analyse technique, sémantique et concurrentielle approfondie. Identification des freins et des opportunités de croissance.',
    ...
    },
    {
      ...
      description: 'Optimisation on-site, structure de contenu, balisage et performance. Les bases d\'un référencement solide.',
    ...
    },
    {
      id: 3,
      title: 'Netlinking',
      description: 'Stratégie de liens pensée pour renforcer votre autorité. Des liens qualitatifs, pas de spam.',
    ...
    },
    {
      ...
      description: 'Rédaction SEO et GEO-ready. Du contenu qui se positionne et convertit votre audience.',
...
export const comparaisonData = {
  ...
  badge: 'SEO + GEO',
  accentColor: 'rw-blue' as const,
  title: 'Ce que les entreprises lilloises gagnent avec le GEO',
...
export const quoteData = {
  quote: 'Technical SEO is the foundation upon which all of your SEO efforts are built. If you don\'t have a good technical foundation, you\'re building a castle on quicksand.',
  author: 'Barry Adams',
  role: 'Founder, Polemic Digital',
};
...
export const faqData = {
  ...
  items: [
    {
      id: '1',
      question: 'Travaillez-vous avec des entreprises à Lille ?',
      answer: 'Oui, nous collaborons avec des entreprises lilloises depuis plusieurs années. Visioconférences régulières, accès à Rankwell One pour suivre vos performances en temps réel, consultant senior dédié joignable par email ou téléphone. La collaboration à distance est parfaitement fluide.',
    },
    {
      id: '2',
      question: 'Quels secteurs accompagnez-vous à Lille ?',
      answer: 'Nous intervenons dans tous les secteurs : grande distribution, e-commerce, textile et mode, logistique, industrie, services B2B, startups tech. Le dénominateur commun : des entreprises qui veulent convertir leur visibilité Search en résultats commerciaux.',
    },
    {
      id: '3',
