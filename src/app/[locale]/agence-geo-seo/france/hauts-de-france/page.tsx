/**
 * PAGE - Agence GEO & SEO en Hauts-de-France
...
// PAGE COMPONENT
// ============================================
export default async function HautsDeFrancePage({ params }: PageProps) {
  const { locale } = await params;
  ...
  const breadcrumbSchemaItems = data.heroData.breadcrumb.map((item) => ({
    name: item.label,
    url: item.href || 'https://www.rankwell.agency/agence-geo-seo/france/hauts-de-france',
  }));
  ...
  return (
    <>
      ...
      <ServiceJsonLd
        service={{
          name: 'Agence GEO et SEO en Hauts-de-France',
          description: data.metadata.description,
          url: 'https://www.rankwell.agency/agence-geo-seo/france/hauts-de-france',
        }}
      />
