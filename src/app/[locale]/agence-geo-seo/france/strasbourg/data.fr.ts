/**
 * DATA - Page Strasbourg (Agence GEO & SEO pour les entreprises strasbourgeoises)
 * URL: /agence-geo-seo/france/strasbourg (FR only)
 *
 * Page locale SANS présence physique
 * Mots-clés: Agence SEO Strasbourg, Agence GEO Strasbourg, Référencement Strasbourg
 */
...
export const metadata = {
  title: 'Agence GEO et SEO pour les entreprises strasbourgeoises - Rankwell',
  description:
    'Expertise SEO et GEO pour les entreprises de Strasbourg. Référencement Google et optimisation pour les moteurs IA. Bureaux à Paris, collaboration à distance efficace. Approche business centrix.',
};
...
export const heroData = {
  ...
  badge: 'strasbourg',
  title: 'Agence GEO et SEO à Strasbourg',
  description:
    'Strasbourg est la capitale européenne et le cœur économique de l\'Alsace. Les entreprises strasbourgeoises évoluent dans un écosystème international où la visibilité digitale fait la différence. SEO, GEO, SEA et Data.',
  primaryCta: {
...
export const introData = {
  ...
  title: 'Une expertise Search nationale accessible aux entreprises strasbourgeoises',
  paragraphs: [
    'Strasbourg et l\'Eurométropole constituent un pôle économique de dimension européenne. Institutions européennes, biotechnologies, automobile, tourisme, services aux entreprises : chaque secteur compte des acteurs qui cherchent à se démarquer. Google ne constitue plus la seule vitrine. ChatGPT, Perplexity et les AI Overviews transforment les parcours de recherche des décideurs.',
    'Rankwell accompagne des entreprises partout en France depuis 2017. Notre expertise GEO et SEO est accessible aux entreprises strasbourgeoises grâce à une <strong>collaboration à distance efficace</strong>. Échanges réguliers en visioconférence, outils collaboratifs, suivi en temps réel via notre plateforme Rankwell One.',
...
export const recapData = {
  sectionId: 'recap',
  badge: 'Rankwell pour Strasbourg',
  title: 'Ce que nous apportons aux entreprises strasbourgeoises',
...
export const geoEducationData = {
  ...
  items: [
    ...
    },
    {
      ...
      desc: 'Les IA vérifient votre crédibilité via les mentions externes : presse spécialisée, médias européens, avis d\'experts. Le netlinking reste essentiel, mais sous une forme renouvelée.',
    },
  ],
};
...
export const calloutData = {
  label: 'Le contexte économique strasbourgeois',
  text: 'L\'Eurométropole de Strasbourg compte plus de 500 000 habitants et accueille le Parlement européen, le Conseil de l\'Europe et la Cour européenne des droits de l\'homme. Première place financière de l\'Est, pôle d\'excellence en biotechnologies et médecine, destination touristique majeure avec son marché de Noël. Une visibilité digitale optimisée permet de rayonner sur les marchés français et européens.',
...
export const expertisesData = {
  ...
  badge: 'Nos services',
  accentColor: 'rw-blue' as const,
  title: 'Nos services GEO & SEO à Strasbourg',
  subtitle: 'Quatre services complémentaires pour renforcer votre présence digitale.',
  items: [
    {
      id: 1,
      title: 'Audit SEO complet',
      description: 'Diagnostic technique, sémantique et concurrentiel. Identification des freins à votre visibilité et des leviers de croissance.',
    ...
    },
    {
      ...
      description: 'Optimisation on-site, architecture de contenu, balisage et performance. Les fondations d\'un référencement pérenne.',
    ...
    },
    {
      id: 3,
      title: 'Netlinking',
      description: 'Acquisition de liens de qualité pour asseoir votre autorité. Une stratégie sur mesure, sans pratiques douteuses.',
...
export const comparaisonData = {
  ...
  badge: 'SEO + GEO',
  accentColor: 'rw-blue' as const,
  title: 'Ce que les entreprises strasbourgeoises gagnent avec le GEO',
...
export const quoteData = {
  quote: 'Search is no longer about ranking first; it\'s about being quoted first.',
  author: 'Jes Scholz',
  role: 'SEO Futurist, ex-CMO Ringier',
};
...
export const faqData = {
  ...
  items: [
    {
      id: '1',
      question: 'Travaillez-vous avec des entreprises à Strasbourg ?',
      answer: 'Oui, nous collaborons avec des entreprises strasbourgeoises depuis plusieurs années. Visioconférences régulières, accès à Rankwell One pour suivre vos performances en temps réel, consultant senior dédié joignable par email ou téléphone. La collaboration à distance est parfaitement fluide.',
    },
    {
      id: '2',
      question: 'Quels secteurs accompagnez-vous à Strasbourg ?',
      answer: 'Nous intervenons dans tous les secteurs : institutions européennes, biotechnologies et santé, tourisme, services aux entreprises, viticulture alsacienne, e-commerce. Le dénominateur commun : des entreprises qui veulent convertir leur visibilité Search en résultats commerciaux.',
    },
    {
      id: '3',
