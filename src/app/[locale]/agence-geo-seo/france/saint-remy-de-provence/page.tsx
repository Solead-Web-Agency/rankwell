/**
 * PAGE - Agence GEO & SEO à Saint-Rémy-de-Provence
 * URL: /agence-geo-seo/france/saint-remy-de-provence (FR only)
 *
...
// PAGE COMPONENT
// ============================================
export default async function SaintRemyDeProvencePage({ params }: PageProps) {
  const { locale } = await params;
  ...
  const breadcrumbSchemaItems = data.heroData.breadcrumb.map((item) => ({
    name: item.label,
    url: item.href || 'https://www.rankwell.agency/agence-geo-seo/france/saint-remy-de-provence',
  }));
  ...
  return (
    <>
      ...
      <ServiceJsonLd
        service={{
          name: 'Agence GEO et SEO à Saint-Rémy-de-Provence',
          description: data.metadata.description,
          url: 'https://www.rankwell.agency/agence-geo-seo/france/saint-remy-de-provence',
        }}
      />
