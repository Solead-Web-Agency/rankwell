/**
 * DATA - Page Reims (Agence GEO & SEO pour les entreprises rémoises)
 * URL: /agence-geo-seo/france/reims (FR only)
 *
 * Page locale SANS présence physique
 * Mots-clés: Agence SEO Reims, Agence GEO Reims, Référencement Reims
 */
...
export const metadata = {
  title: 'Agence GEO et SEO pour les entreprises rémoises - Rankwell',
  description:
    'Expertise SEO et GEO pour les entreprises de Reims et la Champagne. Référencement Google et optimisation pour les moteurs IA. Bureaux à Paris, collaboration à distance efficace. Approche business centrix.',
};
...
export const heroData = {
  ...
  badge: 'reims',
  title: 'Agence GEO et SEO à Reims',
  description:
    'Reims est la capitale du Champagne et un pôle économique majeur du Grand Est. Les entreprises rémoises évoluent dans un écosystème prestigieux où la visibilité digitale fait la différence. SEO, GEO, SEA et Data.',
  primaryCta: {
...
export const introData = {
  ...
  title: 'Une expertise Search nationale accessible aux entreprises rémoises',
  paragraphs: [
    'Reims et son agglomération forment un pôle économique de premier plan. Champagne et viticulture, agroalimentaire, santé, tourisme patrimonial, services : chaque secteur compte des acteurs qui cherchent à se démarquer. Google ne constitue plus la seule vitrine. ChatGPT, Perplexity et les AI Overviews transforment les parcours de recherche des décideurs.',
    'Rankwell accompagne des entreprises partout en France depuis 2017. Notre expertise GEO et SEO est accessible aux entreprises rémoises grâce à une <strong>collaboration à distance efficace</strong>. Échanges réguliers en visioconférence, outils collaboratifs, suivi en temps réel via notre plateforme Rankwell One.',
...
export const recapData = {
  sectionId: 'recap',
  badge: 'Rankwell pour Reims',
  title: 'Ce que nous apportons aux entreprises rémoises',
...
export const geoEducationData = {
  ...
  items: [
    ...
    },
    {
      ...
      desc: 'Les IA vérifient votre crédibilité via les mentions externes : presse spécialisée, guides œnotouristiques, avis d\'experts. Le netlinking reste essentiel, mais sous une forme renouvelée.',
    },
  ],
};
...
export const calloutData = {
  label: 'Le contexte économique rémois',
  text: 'L\'agglomération de Reims compte plus de 300 000 habitants et représente le cœur de la Champagne viticole. Les grandes maisons de champagne (LVMH, Vranken-Pommery, Taittinger) côtoient un tissu d\'ETI et de PME dynamiques. À 45 minutes de Paris en TGV, Reims attire aussi des entreprises de services. Une visibilité digitale optimisée permet de rayonner au-delà de la région.',
...
export const expertisesData = {
  ...
  badge: 'Nos services',
  accentColor: 'rw-blue' as const,
  title: 'Nos services GEO & SEO à Reims',
  subtitle: 'Quatre services complémentaires pour optimiser votre visibilité sur Google et les moteurs IA.',
  items: [
    {
      id: 1,
      title: 'Audit SEO complet',
      description: 'Évaluation technique, sémantique et concurrentielle approfondie de votre site. Un diagnostic précis pour définir les priorités d\'action.',
    ...
    },
    {
      ...
      description: 'Optimisation on-site globale : structuration des contenus, maillage interne, performances techniques et Core Web Vitals pour un site performant.',
    ...
    },
    {
      id: 3,
      title: 'Netlinking',
      description: 'Acquisition de liens de qualité par des partenariats éditoriaux ciblés et pertinents. Aucune technique black-hat, des backlinks solides et pérennes.',
    ...
    },
    {
      ...
      description: 'Rédaction de contenus SEO et GEO-ready qui répondent aux attentes des utilisateurs et des moteurs, et qui convertissent.',
...
export const comparaisonData = {
  ...
  badge: 'SEO + GEO',
  accentColor: 'rw-blue' as const,
  title: 'Ce que les entreprises rémoises gagnent avec le GEO',
...
export const quoteData = {
  quote: 'Clear writing beats SEO writing every time. Study SEO and lead generation so you can pitch content that helps a business grow.',
  author: 'John Doherty',
  role: 'Founder Credo & EditorNinja',
};
...
export const faqData = {
  ...
  items: [
    {
      id: '1',
      question: 'Travaillez-vous avec des entreprises à Reims ?',
      answer: 'Oui, nous collaborons avec des entreprises rémoises depuis plusieurs années. Visioconférences régulières, accès à Rankwell One pour suivre vos performances en temps réel, consultant senior dédié joignable par email ou téléphone. La collaboration à distance est parfaitement fluide.',
    },
    {
      id: '2',
      question: 'Quels secteurs accompagnez-vous à Reims ?',
      answer: 'Nous intervenons dans tous les secteurs : champagne et viticulture, agroalimentaire, œnotourisme, santé, services aux entreprises, e-commerce. Le dénominateur commun : des entreprises qui veulent convertir leur visibilité Search en résultats commerciaux.',
    },
    {
      id: '3',
