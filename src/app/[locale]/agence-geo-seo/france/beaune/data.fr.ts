/**
 * DATA - Page Beaune (Agence GEO & SEO pour les entreprises beaunoise)
 * URL: /agence-geo-seo/france/beaune (FR only)
 *
 * Page locale SANS présence physique
 * Mots-clés: Agence SEO Beaune, Agence GEO Beaune, Référencement Beaune
 */
...
export const metadata = {
  title: 'Agence GEO et SEO pour les entreprises de Beaune - Rankwell',
  description:
    'Expertise SEO et GEO pour les entreprises de Beaune. Référencement Google et optimisation pour les moteurs IA. Bureaux à Paris, collaboration à distance efficace. Approche business centrix.',
};
...
export const heroData = {
  ...
  badge: 'beaune',
  title: 'Agence GEO et SEO à Beaune',
  description:
    'Beaune est la capitale des vins de Bourgogne et un pôle œnotouristique de renommée mondiale. Les entreprises beaunoise portent un patrimoine d\'exception qui mérite une visibilité digitale optimisée. SEO, GEO, SEA et Data.',
  primaryCta: {
...
export const introData = {
  ...
  title: 'Une expertise Search nationale accessible aux entreprises de Beaune',
  paragraphs: [
    'Beaune et la Côte-d\'Or constituent un écosystème économique unique au monde. Viticulture de prestige, œnotourisme, gastronomie, hôtellerie haut de gamme : chaque acteur évolue sur des marchés exigeants avec une clientèle internationale. Google ne représente plus l\'unique canal de visibilité. ChatGPT, Perplexity et les AI Overviews transforment les parcours de recherche des voyageurs et acheteurs.',
    'Rankwell accompagne des entreprises dans toute la France depuis 2017. Notre expertise GEO et SEO est accessible aux entreprises de Beaune grâce à une <strong>collaboration à distance efficace</strong>. Échanges réguliers en visioconférence, outils collaboratifs partagés, suivi en temps réel via notre plateforme Rankwell One.',
...
export const recapData = {
  sectionId: 'recap',
  badge: 'Rankwell pour Beaune',
  title: 'Ce que nous apportons aux entreprises de Beaune',
...
export const geoEducationData = {
  ...
  items: [
    ...
    },
    {
      ...
      desc: 'Les IA valident votre crédibilité grâce aux mentions externes : guides œnologiques, presse spécialisée, avis d\'experts. Le netlinking reste essentiel, mais sous une forme renouvelée.',
    },
  ],
};
...
export const calloutData = {
  label: 'Le contexte économique beaunois',
  text: 'Beaune compte 22 000 habitants et accueille plus de 400 000 visiteurs par an, attirés par les Hospices de Beaune et la Route des Grands Crus. Le négoce viticole, l\'œnotourisme, l\'hôtellerie-restauration et l\'artisanat de luxe forment un écosystème à forte valeur ajoutée. Une présence digitale optimisée permet de capter cette clientèle internationale en amont de leur voyage.',
  ...
  items: [
    {
      ...
      description:
        'Être premier sur un mot-clé sans potentiel commercial n\'a pas de sens. Notre indicateur principal, c\'est l\'impact sur votre activité : réservations, ventes de vins, chiffre d\'affaires attribué.',
    },
    {
      id: 2,
      icon: 'MessageCircle',
  ...
  criteria: [
    {
      ...
      description: 'Votre site existe mais ne génère pas suffisamment de réservations ou de commandes. Vous recherchez un partenaire pour élaborer et déployer une stratégie Search performante.',
    },
    {
...
export const expertisesData = {
  ...
  badge: 'Nos services',
  accentColor: 'rw-blue' as const,
  title: 'Nos services GEO & SEO à Beaune',
  subtitle: 'Quatre services complémentaires pour booster votre visibilité digitale.',
  items: [
    {
      id: 1,
      title: 'Audit SEO complet',
      description: 'Analyse technique, sémantique et concurrentielle. Identification des blocages et des leviers de croissance.',
    ...
    },
    {
      ...
      description: 'Optimisation on-site, architecture de contenu, balisage et performance. Les bases d\'un référencement pérenne.',
    ...
    },
    {
      id: 3,
      title: 'Netlinking',
      description: 'Stratégie de liens qualitatifs pour asseoir votre autorité. Pas de pratiques risquées.',
    ...
    },
    {
      ...
      description: 'Contenus optimisés SEO et GEO-ready. Du contenu qui se positionne et génère des conversions.',
...
export const comparaisonData = {
  ...
  badge: 'SEO + GEO',
  accentColor: 'rw-blue' as const,
  title: 'Ce que les entreprises de Beaune gagnent avec le GEO',
...
export const quoteData = {
  quote: 'Don\'t start with the SEO. Start with what the customer wants. That\'s the kind of content we should create.',
  author: 'Paddy Moogan',
  role: 'Co-founder, Aira',
};
...
export const faqData = {
  ...
  items: [
    {
      id: '1',
      question: 'Travaillez-vous avec des entreprises à Beaune ?',
      answer: 'Oui, nous collaborons avec des entreprises beaunoise depuis plusieurs années. Visioconférences régulières, accès à Rankwell One pour suivre vos performances en temps réel, consultant senior dédié joignable par email ou téléphone. La collaboration à distance est parfaitement fluide.',
    },
    {
      id: '2',
      question: 'Quels secteurs accompagnez-vous à Beaune ?',
      answer: 'Nous intervenons dans tous les secteurs : viticulture et négoce de vins (le cœur de l\'économie beaunoise), œnotourisme, hôtellerie-restauration, commerce de luxe, e-commerce. Le dénominateur commun : des entreprises qui veulent convertir leur visibilité Search en résultats commerciaux.',
    },
    {
      id: '3',
