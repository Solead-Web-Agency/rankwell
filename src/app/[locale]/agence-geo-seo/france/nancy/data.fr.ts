/**
 * DATA - Page Nancy (Agence GEO & SEO pour les entreprises nancéiennes)
 * URL: /agence-geo-seo/france/nancy (FR only)
 *
 * Page locale SANS présence physique
 * Mots-clés: Agence SEO Nancy, Agence GEO Nancy, Référencement Nancy
 */
...
export const metadata = {
  title: 'Agence GEO et SEO pour les entreprises nancéiennes - Rankwell',
  description:
    'Expertise SEO et GEO pour les entreprises de Nancy. Référencement Google et optimisation pour les moteurs IA. Bureaux à Paris, collaboration à distance efficace. Approche business centrix.',
};
...
export const heroData = {
  ...
  badge: 'nancy',
  title: 'Agence GEO et SEO à Nancy',
  description:
    'Nancy est la capitale historique de la Lorraine et une métropole universitaire dynamique. Les entreprises nancéiennes évoluent dans un écosystème innovant où la visibilité digitale fait la différence. SEO, GEO, SEA et Data.',
  primaryCta: {
...
export const introData = {
  ...
  title: 'Une expertise Search nationale accessible aux entreprises nancéiennes',
  paragraphs: [
    'Nancy et le Grand Nancy forment un pôle économique reconnu pour son dynamisme. Santé et biotechnologies, matériaux, numérique, art et patrimoine, services : chaque secteur compte des acteurs qui cherchent à se démarquer. Google ne représente plus l\'unique vitrine. ChatGPT, Perplexity et les AI Overviews redéfinissent les parcours de recherche des décideurs.',
    'Rankwell accompagne des entreprises dans toute la France depuis 2017. Notre expertise GEO et SEO est accessible aux entreprises nancéiennes grâce à une <strong>collaboration à distance efficace</strong>. Échanges réguliers en visioconférence, outils collaboratifs, suivi en temps réel via notre plateforme Rankwell One.',
...
export const recapData = {
  sectionId: 'recap',
  badge: 'Rankwell pour Nancy',
  title: 'Ce que nous apportons aux entreprises nancéiennes',
...
export const geoEducationData = {
  ...
  items: [
    ...
    },
    {
      ...
      desc: 'Les IA vérifient votre crédibilité via les mentions externes : presse spécialisée, médias universitaires, avis d\'experts. Le netlinking reste essentiel, mais sous une forme renouvelée.',
    },
  ],
};
...
export const calloutData = {
  label: 'Le contexte économique nancéien',
  text: 'Le Grand Nancy compte plus de 260 000 habitants et accueille 50 000 étudiants, ce qui en fait un pôle universitaire majeur. La Place Stanislas classée UNESCO, les écoles d\'ingénieurs, le CHU et les pôles de recherche forment un écosystème d\'innovation. Matériaux, santé, numérique : Nancy se positionne sur des secteurs d\'avenir. Une visibilité digitale optimisée permet de rayonner au-delà de la région.',
...
export const expertisesData = {
  ...
  badge: 'Nos services',
  accentColor: 'rw-blue' as const,
  title: 'Nos services GEO & SEO à Nancy',
  subtitle: 'Quatre services complémentaires pour accroître votre visibilité sur Google et les moteurs IA.',
  items: [
    {
      id: 1,
      title: 'Audit SEO complet',
      description: 'Analyse approfondie technique, sémantique et concurrentielle. Un diagnostic complet pour cartographier vos forces et vos opportunités de progression.',
    ...
    },
    {
      ...
      description: 'Optimisation on-site exhaustive : hiérarchisation des contenus, maillage interne, performances web et Core Web Vitals pour un socle technique performant.',
    ...
    },
    {
      id: 3,
      title: 'Netlinking',
      description: 'Développement d\'un réseau de liens de qualité via des collaborations éditoriales sélectionnées. Pas de spam, uniquement des backlinks qui renforcent votre autorité.',
    ...
    },
    {
      ...
      description: 'Élaboration de contenus SEO et GEO-ready pensés pour répondre aux intentions de recherche et convertir efficacement vos visiteurs.',
...
export const comparaisonData = {
  ...
  badge: 'SEO + GEO',
  accentColor: 'rw-blue' as const,
  title: 'Ce que les entreprises nancéiennes gagnent avec le GEO',
...
export const quoteData = {
  quote: 'If you don\'t start thinking around entities, you\'re going to be screwed in the end. Entities are the glue that sticks ideas together.',
  author: 'Dixon Jones',
  role: 'CEO of InLinks, former Marketing Director at Majestic',
};
...
export const faqData = {
  ...
  items: [
    {
      id: '1',
      question: 'Travaillez-vous avec des entreprises à Nancy ?',
      answer: 'Oui, nous collaborons avec des entreprises nancéiennes depuis plusieurs années. Visioconférences régulières, accès à Rankwell One pour suivre vos performances en temps réel, consultant senior dédié joignable par email ou téléphone. La collaboration à distance est parfaitement fluide.',
    },
    {
      id: '2',
      question: 'Quels secteurs accompagnez-vous à Nancy ?',
      answer: 'Nous intervenons dans tous les secteurs : santé et biotechnologies, matériaux et industrie, numérique et startups, tourisme culturel, services aux entreprises, e-commerce. Le dénominateur commun : des entreprises qui veulent convertir leur visibilité Search en résultats commerciaux.',
    },
    {
      id: '3',
...
export const autresVillesData = {
  ...
  cities: [
    ...
    { label: 'Colmar', href: '/agence-geo-seo/france/colmar' },
