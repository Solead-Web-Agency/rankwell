/**
 * DATA - Page Rouen (Agence GEO & SEO pour les entreprises rouennaises)
 * URL: /agence-geo-seo/france/rouen (FR only)
 *
 * Page locale SANS présence physique
 * Mots-clés: Agence SEO Rouen, Agence GEO Rouen, Référencement Rouen
 */
...
export const heroData = {
  ...
  badge: 'rouen',
  title: 'Agence GEO et SEO à Rouen',
  description:
    'Rouen est la capitale de la Normandie et un pôle économique majeur sur l\'axe Seine. Les entreprises rouennaises évoluent dans un écosystème dynamique où la visibilité digitale fait la différence. SEO, GEO, SEA et Data.',
  primaryCta: {
...
export const introData = {
  ...
  title: 'Une expertise Search nationale accessible aux entreprises rouennaises',
  paragraphs: [
    'Rouen et son agglomération forment un pôle économique de premier plan. Port fluvial et maritime, industrie pharmaceutique et chimique, services financiers, tourisme culturel : chaque secteur compte des acteurs qui cherchent à se démarquer. Google ne constitue plus la seule vitrine. ChatGPT, Perplexity et les AI Overviews transforment les parcours de recherche des décideurs.',
    'Rankwell accompagne des entreprises partout en France depuis 2017. Notre expertise GEO et SEO est accessible aux entreprises rouennaises grâce à une <strong>collaboration à distance efficace</strong>. Échanges réguliers en visioconférence, outils collaboratifs, suivi en temps réel via notre plateforme Rankwell One.',
...
export const recapData = {
  sectionId: 'recap',
  badge: 'Rankwell pour Rouen',
  title: 'Ce que nous apportons aux entreprises rouennaises',
...
export const calloutData = {
  label: 'Le contexte économique rouennais',
  text: 'L\'agglomération de Rouen compte plus de 500 000 habitants et constitue le cœur de l\'axe Seine, premier corridor logistique français. Quatrième port français, la métropole rouennaise abrite aussi des pôles d\'excellence en chimie, pharmacie et assurance. Une visibilité digitale optimisée permet de rayonner au-delà des frontières régionales.',
...
export const expertisesData = {
  ...
  badge: 'Nos services',
  accentColor: 'rw-blue' as const,
  title: 'Nos services GEO & SEO à Rouen',
  subtitle: 'Quatre services complémentaires pour renforcer votre visibilité digitale et générer des conversions.',
  items: [
    {
      id: 1,
      title: 'Audit SEO complet',
      description: 'Analyse technique, sémantique et concurrentielle pour identifier les opportunités et les freins à votre référencement.',
    ...
    },
    {
      ...
      description: 'Optimisation on-site, structuration des contenus et amélioration des performances pour un site qui plaît aux moteurs.',
    ...
    },
    {
      id: 3,
      title: 'Netlinking',
      description: 'Acquisition de liens de qualité provenant de sites pertinents. Zéro spam, uniquement des backlinks qui comptent.',
...
export const comparaisonData = {
  ...
  badge: 'SEO + GEO',
  accentColor: 'rw-blue' as const,
  title: 'Ce que les entreprises rouennaises gagnent avec le GEO',
...
export const faqData = {
  ...
  items: [
    {
      id: '1',
      question: 'Travaillez-vous avec des entreprises à Rouen ?',
      answer: 'Oui, nous collaborons avec des entreprises rouennaises depuis plusieurs années. Visioconférences régulières, accès à Rankwell One pour suivre vos performances en temps réel, consultant senior dédié joignable par email ou téléphone. La collaboration à distance est parfaitement fluide.',
    },
    {
      id: '2',
      question: 'Quels secteurs accompagnez-vous à Rouen ?',
      answer: 'Nous intervenons dans tous les secteurs : logistique et portuaire, chimie et pharmacie, assurance et services financiers, tourisme culturel, e-commerce. Le dénominateur commun : des entreprises qui veulent convertir leur visibilité Search en résultats commerciaux.',
    },
    {
      id: '3',
