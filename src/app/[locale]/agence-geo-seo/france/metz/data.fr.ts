/**
 * DATA - Page Metz (Agence GEO & SEO pour les entreprises messines)
 * URL: /agence-geo-seo/france/metz (FR only)
 *
 * Page locale SANS présence physique
 * Mots-clés: Agence SEO Metz, Agence GEO Metz, Référencement Metz
 */
...
export const metadata = {
  title: 'Agence GEO et SEO pour les entreprises messines - Rankwell',
  description:
    'Expertise SEO et GEO pour les entreprises de Metz. Référencement Google et optimisation pour les moteurs IA. Bureaux à Paris, collaboration à distance efficace. Approche business centrix.',
};
...
export const heroData = {
  ...
  badge: 'metz',
  title: 'Agence GEO et SEO à Metz',
  description:
    'Metz est la préfecture de la Moselle et un carrefour économique au cœur du Sillon lorrain. Les entreprises messines évoluent dans un territoire transfrontalier dynamique où la visibilité digitale fait la différence. SEO, GEO, SEA et Data.',
  primaryCta: {
...
export const introData = {
  ...
  title: 'Une expertise Search nationale accessible aux entreprises messines',
  paragraphs: [
    'Metz et son agglomération constituent un pôle économique stratégique. Automobile, logistique, numérique, tourisme culturel, services : chaque secteur compte des acteurs qui cherchent à se démarquer. Google ne représente plus l\'unique vitrine. ChatGPT, Perplexity et les AI Overviews redéfinissent les parcours de recherche des décideurs.',
    'Rankwell accompagne des entreprises dans toute la France depuis 2017. Notre expertise GEO et SEO est accessible aux entreprises messines grâce à une <strong>collaboration à distance efficace</strong>. Échanges réguliers en visioconférence, outils collaboratifs, suivi en temps réel via notre plateforme Rankwell One.',
...
export const recapData = {
  sectionId: 'recap',
  badge: 'Rankwell pour Metz',
  title: 'Ce que nous apportons aux entreprises messines',
...
export const geoEducationData = {
  ...
  items: [
    ...
    },
    {
      ...
      desc: 'Les IA vérifient votre crédibilité via les mentions externes : presse spécialisée, médias économiques, avis d\'experts. Le netlinking reste essentiel, mais sous une forme renouvelée.',
    },
  ],
};
...
export const calloutData = {
  label: 'Le contexte économique messin',
  text: 'Metz Métropole compte près de 230 000 habitants et bénéficie d\'une position géographique stratégique au cœur de la Grande Région (Luxembourg, Allemagne, Belgique). Le Centre Pompidou-Metz a renforcé l\'attractivité touristique. Technopôle de Metz 2000, pôle automobile, numérique : l\'économie se diversifie. Une visibilité digitale optimisée permet de rayonner sur les marchés français et transfrontaliers.',
...
export const expertisesData = {
  ...
  badge: 'Nos services',
  accentColor: 'rw-blue' as const,
  title: 'Nos services GEO & SEO à Metz',
  subtitle: 'Quatre services complémentaires pour booster votre visibilité sur Google et les moteurs IA.',
  items: [
    {
      id: 1,
      title: 'Audit SEO complet',
      description: 'Évaluation technique, sémantique et concurrentielle de votre site. Un état des lieux précis pour identifier vos axes d\'amélioration prioritaires.',
    ...
    },
    {
      ...
      description: 'Optimisation on-site intégrale : structuration des contenus, maillage interne, vitesse de chargement et Core Web Vitals pour des fondations techniques solides.',
    ...
    },
    {
      id: 3,
      title: 'Netlinking',
      description: 'Construction d\'un profil de liens qualitatif via des partenariats éditoriaux ciblés. Aucune pratique douteuse, uniquement des backlinks pérennes.',
    ...
    },
    {
      ...
      description: 'Production de contenus optimisés SEO et GEO-ready qui engagent vos audiences et transforment les visiteurs en prospects qualifiés.',
...
export const comparaisonData = {
  ...
  badge: 'SEO + GEO',
  accentColor: 'rw-blue' as const,
  title: 'Ce que les entreprises messines gagnent avec le GEO',
...
export const quoteData = {
  quote: 'A website can be perfect in terms of technical SEO and even localization, but then it uses a tone of voice that sounds totally out of this world in the local culture.',
  author: 'Gianluca Fiorelli',
  role: 'Strategic & International SEO Consultant, ILoveSEO',
};
...
export const faqData = {
  ...
  items: [
    {
      id: '1',
      question: 'Travaillez-vous avec des entreprises à Metz ?',
      answer: 'Oui, nous collaborons avec des entreprises messines depuis plusieurs années. Visioconférences régulières, accès à Rankwell One pour suivre vos performances en temps réel, consultant senior dédié joignable par email ou téléphone. La collaboration à distance est parfaitement fluide.',
    },
    {
      id: '2',
      question: 'Quels secteurs accompagnez-vous à Metz ?',
      answer: 'Nous intervenons dans tous les secteurs : automobile, logistique, numérique et tech, tourisme culturel, services aux entreprises, e-commerce. Le dénominateur commun : des entreprises qui veulent convertir leur visibilité Search en résultats commerciaux.',
    },
    {
      id: '3',
