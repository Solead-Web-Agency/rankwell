...
export const quoteData = {
  quote: 'Being able to better understand data will lead to better decisions being made. Anyone can learn the tools with a little commitment.',
  author: 'Ruth Everett',
  role: 'SEO Testing Consultant, SearchPilot',
};
