/**
 * PAGE - Agence GEO & SEO à Aix-en-Provence
 * URL: /agence-geo-seo/france/aix-en-provence (FR only)
 *
...
// PAGE COMPONENT
// ============================================
export default async function AixEnProvencePage({ params }: PageProps) {
  const { locale } = await params;
  ...
  const breadcrumbSchemaItems = data.heroData.breadcrumb.map((item) => ({
    name: item.label,
    url: item.href || 'https://www.rankwell.agency/agence-geo-seo/france/aix-en-provence',
  }));
  ...
  return (
    <>
      ...
      <ServiceJsonLd
        service={{
          name: 'Agence GEO et SEO à Aix-en-Provence',
          description: data.metadata.description,
          url: 'https://www.rankwell.agency/agence-geo-seo/france/aix-en-provence',
        }}
      />
