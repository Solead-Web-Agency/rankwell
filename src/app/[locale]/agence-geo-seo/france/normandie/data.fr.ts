/**
 * DATA - Page Normandie (Agence GEO & SEO pour les entreprises normandes)
 * URL: /agence-geo-seo/france/normandie (FR only)
 *
 * Page régionale SANS présence physique
 * Mots-clés: Agence SEO Normandie, Agence GEO Normandie, Référencement Normandie
 */
...
export const metadata = {
  title: 'Agence GEO et SEO pour les entreprises normandes - Rankwell',
  description:
    'Expertise SEO et GEO pour les entreprises de Normandie. Référencement Google et optimisation pour les moteurs IA. Bureaux à Paris, collaboration à distance efficace. Approche business centrix.',
};
...
export const heroData = {
  ...
  badge: 'normandie',
  title: 'Agence GEO et SEO en Normandie',
  description:
    'La Normandie conjugue patrimoine maritime, industrie portuaire et innovation. Rouen, Caen, Le Havre, Deauville... autant de pôles économiques où les entreprises normandes peuvent accroître leur visibilité digitale. SEO, GEO, SEA et Data.',
  primaryCta: {
...
export const introData = {
  ...
  title: 'Une expertise Search nationale au service des entreprises normandes',
  paragraphs: [
    'La Normandie représente un territoire économique majeur à la croisée de l\'Europe maritime. Industrie portuaire, agroalimentaire, tourisme patrimonial et balnéaire, énergie : les secteurs qui font la richesse régionale nécessitent aujourd\'hui une présence digitale performante. Google ne constitue plus l\'unique vitrine. ChatGPT, Perplexity et les AI Overviews modifient les comportements de recherche des décideurs.',
    'Rankwell accompagne des entreprises sur l\'ensemble du territoire national depuis 2017. Notre maîtrise du GEO et du SEO profite aux entreprises normandes via une <strong>collaboration à distance efficace</strong>. Points réguliers en visioconférence, outils collaboratifs, reporting en temps réel via notre plateforme Rankwell One.',
...
export const recapData = {
  sectionId: 'recap',
  badge: 'Rankwell pour la Normandie',
  title: 'Ce que nous apportons aux entreprises normandes',
...
export const calloutData = {
  label: 'L\'économie normande',
  text: 'La Normandie compte 3,3 millions d\'habitants et accueille le premier complexe portuaire français avec l\'axe Seine (Le Havre, Rouen). Première région agroalimentaire de France, elle développe aussi ses pôles pharmaceutique, automobile et nucléaire. Une visibilité digitale optimisée permet de rayonner au-delà des frontières régionales.',
...
export const expertisesData = {
  ...
  badge: 'Nos services',
  accentColor: 'rw-blue' as const,
  title: 'Nos services GEO & SEO en Normandie',
  subtitle: 'Quatre services complémentaires pour maximiser votre visibilité sur Google et les moteurs IA.',
  items: [
    {
      id: 1,
      title: 'Audit SEO complet',
      description: 'Diagnostic technique, sémantique et concurrentiel approfondi. Une radiographie de votre site pour prioriser les actions à fort impact.',
    ...
    },
    {
      ...
      description: 'Optimisation on-site complète : organisation des contenus, maillage interne, rapidité et Core Web Vitals pour un site techniquement irréprochable.',
    ...
    },
    {
      id: 3,
      title: 'Netlinking',
      description: 'Acquisition de backlinks de qualité grâce à des partenariats éditoriaux pertinents. Zéro pratique black-hat, uniquement des liens durables et légitimes.',
    ...
    },
    {
      ...
      description: 'Rédaction de contenus SEO et GEO-ready conçus pour capter l\'attention, satisfaire les moteurs et générer des conversions mesurables.',
...
export const comparaisonData = {
  ...
  badge: 'SEO + GEO',
  accentColor: 'rw-blue' as const,
  title: 'Ce que les entreprises normandes gagnent avec le GEO',
...
export const quoteData = {
  quote: 'There\'s so much shiny and exciting stuff around, but one of the things we need to really focus on is the basics. The bigger the sites, the more complicated things are.',
  author: 'Gerry White',
  role: 'SEO & Technical Marketing Consultant, Dergal',
};
...
export const faqData = {
  ...
  items: [
    {
      id: '1',
      question: 'Travaillez-vous avec des entreprises en Normandie ?',
      answer: 'Oui, nous collaborons avec des entreprises normandes depuis plusieurs années. Visioconférences régulières, accès à Rankwell One pour suivre vos performances en temps réel, consultant senior dédié joignable par email ou téléphone. La collaboration à distance fonctionne parfaitement.',
    },
    {
      id: '2',
      question: 'Quels secteurs accompagnez-vous en Normandie ?',
      answer: 'Nous intervenons dans tous les secteurs : portuaire et logistique, agroalimentaire, tourisme patrimonial et balnéaire, énergie, industrie automobile. Le dénominateur commun : des entreprises qui veulent transformer leur visibilité Search en résultats commerciaux.',
    },
    {
      id: '3',
...
export const autresVillesData = {
  title: 'Découvrez aussi nos services dans ces villes normandes',
  cities: [
